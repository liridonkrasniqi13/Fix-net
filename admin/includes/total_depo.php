...
$query = "SELECT SUM(resiver) AS sum FROM depo $filter_date ";
...
$query = "SELECT SUM(modem) AS sum FROM depo $filter_date";
$query_result = mysqli_query($connection, $query);
...
$query = "SELECT SUM(rg6) AS sum FROM depo $filter_date";
$query_result = mysqli_query($connection, $query);
...
$query = "SELECT SUM(konektor_rg6) AS sum FROM depo $filter_date";
$query_result = mysqli_query($connection, $query);
...
$query = "SELECT SUM(spliter) AS sum FROM depo $filter_date";
$query_result = mysqli_query($connection, $query);
...
$query = "SELECT SUM(konektor_tv) AS sum FROM depo $filter_date";
$query_result = mysqli_query($connection, $query);
...
$query = "SELECT SUM(rg11) AS sum FROM depo $filter_date";
$query_result = mysqli_query($connection, $query);
...
$query = "SELECT SUM(t32) AS sum FROM depo $filter_date";
$query_result = mysqli_query($connection, $query);
...
$query = "SELECT SUM(kupler_7402) AS sum FROM depo $filter_date";
$query_result = mysqli_query($connection, $query);
...
$query = "SELECT SUM(amp) AS sum FROM depo $filter_date";
$query_result = mysqli_query($connection, $query);
...
$query = "SELECT SUM(tap_26) AS sum FROM depo $filter_date";
$query_result = mysqli_query($connection, $query);
...
$query = "SELECT SUM(tap_23) AS sum FROM depo $filter_date";
$query_result = mysqli_query($connection, $query);
...
$query = "SELECT SUM(tap_20) AS sum FROM depo $filter_date";
$query_result = mysqli_query($connection, $query);
...
$query = "SELECT SUM(tap_17) AS sum FROM depo $filter_date";
$query_result = mysqli_query($connection, $query);
...
$query = "SELECT SUM(tap_14) AS sum FROM depo $filter_date";
$query_result = mysqli_query($connection, $query);
...
$query = "SELECT SUM(tap_11) AS sum FROM depo $filter_date";
$query_result = mysqli_query($connection, $query);
...
$query = "SELECT SUM(tap_10) AS sum FROM depo $filter_date";
$query_result = mysqli_query($connection, $query);
...
$query = "SELECT SUM(tap_8) AS sum FROM depo $filter_date";
$query_result = mysqli_query($connection, $query);
...
$query = "SELECT SUM(tap_4) AS sum FROM depo $filter_date";
$query_result = mysqli_query($connection, $query);
...
$dallimiResiver = $resiver - $vetura_resiver;
$dallimiModem = $modem - $vetura_modem;
$dallimiRg6 = $rg6 - $vetura_rg6;
$dallimikonektor_rg6 = $post_konektor_rg6 - $vetura_konektor_rg6;
$dallimispliter = $post_spliter - $vetura_spliter;
$dallimikonektor_tv = $post_konektor_tv - $vetura_konektor_tv;
$dallimirg11 = $post_rg11 - $vetura_rg11;
$dallimit32 = $post_t32 - $vetura_t32;
$dallimikupler_7402 = $post_kupler_7402 - $vetura_kupler_7402;
$dallimi_amp = $post_amp - $vetura_amp;
$dallimi_tap_26 = $tap_26 - $vetura_tap_26;
$dallimi_tap_23 = $tap_23 - $vetura_tap_23;
$dallimi_tap_20 = $tap_20 - $vetura_tap_20;
$dallimi_tap_17 = $tap_17 - $vetura_tap_17;
$dallimi_tap_14 = $tap_14 - $vetura_tap_14;
$dallimi_tap_11 = $tap_11 - $vetura_tap_11;
$dallimi_tap_10 = $tap_10 - $vetura_tap_10;
$dallimi_tap_8 = $tap_8 - $vetura_tap_8;
$dallimi_tap_4 =  $tap_4 - $vetura_tap_4 ;
