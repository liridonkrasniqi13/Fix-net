...
<div class="table-responsive">
        ...
        <tbody>
            ...
            <?php
                ...
                if (($_SESSION['user_role'] == "admin") || ($_SESSION['user_role'] == "superadmin")) {
                    ...
                    $post_query_count = "SELECT * FROM project";
                    $find_conut = mysqli_query($connection, $post_query_count);
                    $cont = mysqli_num_rows($find_conut);

                    $cont = ceil($cont / $per_page);

                    $query = "SELECT * FROM project ORDER BY id DESC LIMIT $page_1 , $per_page"; //  LIMIT $page_1 , 5
                ...
                <?php
                    ...
                    echo "<td><a href='project_view.php?p_id={$id}'>View Post</a></td>";
                    if (($_SESSION['user_role'] == "admin") || ($_SESSION['user_role'] == "superadmin")) {
                        echo "<td><a href='project.php?source=edit_project&p_id={$id}'>Edit</a></td>";
                        echo "<td><a onClick=\"javascript: return confirm('Are you sure you want to delete'); \" href='project.php?delete={$id}'>Delete</a></td>";
                    }
                    echo "</tr>";
                }
    ...
    if (isset($_GET['delete'])) {
        ...
        $query = "DELETE FROM project WHERE id = {$the_post_id}";
